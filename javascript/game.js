...
function show_score() {
  ...
  console.log(
    ...
    $(window).width() -
      ...
      (500 - x),
    $(window).height() -
      (offset.top + $("#solution-map").outerHeight()) +
      (500 - y)
  );
  $("#answer").css(
    "right",
...
function show_results() {
  ...
  for (var i = 0; i < MAX_ROUND; i++) {
    ...
    locs =
      locs +
      `<div class='solution' style='right: ${
        $(window).width() -
        (offset.left + $("#solution-map").outerWidth()) +
        ...
        10
                                                    ...
                                                    bottom: ${
                                                      ...
                                                      (500 -
                                                        locs_selected[i].y) -
                                                      10
                                                    }px;'><i class="fa-solid fa-font-awesome"></i></div>`;

    connections =
      connections +
      `<path stroke-dasharray="4,4" d="M${answers[i][0]} ${answers[i][1]} l${
        locs_selected[i].x - answers[i][0]
